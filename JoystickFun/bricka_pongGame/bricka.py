"""
 ...
 This application is modified to work with Arduino's Joystick Serial control
 Modified by Gurinder Singh Gill (gsgill112 @GitHub) gsgill112@gmail.com
 03232015 0450Hr

 Bangalore MakeSpace and OpenSource Creativity 
...
class Bricka:
    ...
    def check_input(self):
        ...
        #if serial_input >300 and serial_input<600 and self.state == STATE_BALL_IN_PADDLE:
            self.ball_vel = [5,-5]
